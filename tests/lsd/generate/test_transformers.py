...
class TestHuggingFaceModel:
    ...
    def mock_model(self):
        ...
        output = Mock()
        output.last_hidden_state = torch.randn(1, 4, 768)  # batch_size=1, seq_len=4, hidden_size=768
    ...
    def test_huggingface_model_initialization(self, mock_tokenizer_class, mock_model_class, sample_config):
        ...
        mock_model_class.from_pretrained.assert_called_once_with("distilbert-base-uncased")

    @patch('lsd.generate.transformers.models.huggingface.AutoModel')
    @patch('lsd.generate.transformers.models.huggingface.AutoTokenizer')
    def test_huggingface_model_embed(self, mock_tokenizer_class, mock_model_class, sample_config):
    ...
    def test_process_text_single_string(self, sample_config):
        ...
        with patch('lsd.generate.transformers.models.huggingface.AutoModel'), \
             patch('lsd.generate.transformers.models.huggingface.AutoTokenizer') as mock_tokenizer_class:
...
class TestSentenceTransformerModel:
    ...
    def test_sbert_model_embed(self, mock_st_class, sample_config):
        ...
        mock_st_instance.encode.assert_called_once_with("This is a test sentence.", convert_to_tensor=True)
...
class TestTransformer:
    ...
    def test_transformer_initialization(self, mock_importlib, mock_load_dataset, sample_params):
    ...
    @patch('lsd.generate.transformers.tf.load_dataset')
    @patch('lsd.generate.transformers.tf.importlib')
    def test_transformer_generate(self, mock_importlib, mock_load_dataset, sample_params):
    ...
    def test_extract_texts_from_dataset_huggingface_format(self):
        ...
        transformer = Transformer.__new__(Transformer)  # Create without calling __init__
        ...
        expected = ["First article text", "Second article text", "Third article text"]
    ...
    def test_extract_texts_from_dataset_empty_dataset(self):
        ...
        with pytest.raises(ValueError, match="No text content found in dataset"):
...
class TestTransformerIntegration:
    ...
    def test_transformer_configs_exist(self):
        ...
        from lsd.generate.transformers.configs import (
            Mistral, Ada, MiniLM, arXiv, CNN, Tokenizer
        )
